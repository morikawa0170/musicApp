            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            <label for="spotify_id" class="col-md-4 col-form-label text-md-right">{{ __('spotifyユーザ名') }}</label>
                            ...
                            <div class="col-md-6">
                                ...
                                @enderror
                                <a href="https://www.spotify.com/jp/account/overview/?utm_source=spotify&utm_medium=menu&utm_campaign=your_account" style="font-size:13px;" class="d-flex justify-content-end">spotifyユーザー名の確認はこちら</a>
                            </div>
                        </div>
